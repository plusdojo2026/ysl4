...
<body class="summary-page">
	...
	<main class="summary-main">
		...
		<section class="summary-stack">
			...
			<div class="summary-card summary-table-card">
				<div class="summary-card-header">
					<h2>案件別工数</h2>
				</div>

				<div class="summary-table-wrap">
					<table id="project-summary-table" class="summary-table summary-project-table">
						<colgroup>
							<col class="summary-col-code">
							<col class="summary-col-name">
							<col class="summary-col-hours">
							<col class="summary-col-hours">
			...
			<div class="summary-card summary-table-card">
				...
				<div class="summary-table-wrap">
					<table id="member-summary-table" class="summary-table summary-member-table">
						<colgroup>
							<col class="summary-col-member">
							<col class="summary-col-hours">
							<col class="summary-col-hours">
							<col class="summary-col-count">
							<col class="summary-col-rate">
						</colgroup>
		...
		<section class="summary-card summary-detail-card">
			<div class="summary-card-header">
				<h2>工数明細</h2>
			</div>
			...
			<div class="summary-table-wrap">
				<table id="worklog-summary-table" class="summary-table summary-worklog-table">
					<colgroup>
						<col class="summary-col-date">
						<col class="summary-col-project">
						<col class="summary-col-task">
						<col class="summary-col-user">
						<col class="summary-col-workhours">
						<col class="summary-col-content">
					</colgroup>

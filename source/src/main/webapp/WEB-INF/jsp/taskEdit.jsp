...
<input type="hidden" name="page_id" value="T004">
    ...
    <div class="field">
        ...
        <input type="text" id="task_name" name="task_name" value="${taskList.taskName}">
    </div>
    ...
    <div class="field">
        ...
        <select id="status"name="status" value="${taskList.priority}">
    ...
    <div class="field">
        ...
        <input type="date" id="start_date" name="start_date" value="${taskList.startDate}">
    </div>
    ...
    <div class="field">
        ...
        <input type="date" id="due_date" name="due_date" value="${taskList.dueDate}">
    </div>
    ...
    <div class="field">
        ...
        <input type="text" id="estimatedManhours" name="estimatedManhours" value="${taskList.estimatedManhours}">
    </div>

	...
	<main class="member-main">
		...
		<section class="member-hero">
			...
			<div class="member-hero-text">
				...
				<div class="hero-note-row">
					<span class="admin-pill">管理者専用</span> <span class="hero-note">メンバー情報を確認・編集できます</span>
				</div>
			</div>
			...
			<div class="member-hero-action">
				<form action="${pageContext.request.contextPath}/Controller"
					...
					<button type="submit" class="regist-btn">
						<span class="plus-mark">＋</span> メンバー登録
					</button>
				</form>
			</div>
		</section>
		...
		<section class="member-dashboard">
			<div class="member-count">
				...
				<div class="member-count-text">
					<span class="member-count-label">総メンバー数</span> <span
						class="actual-member-count" id="totalMemberCount">0</span> <span
						class="member-count-unit">人</span>
				</div>
			</div>
			...
			<div class="member-count">
				...
				<div class="member-count-text">
					<span class="member-count-label">有効メンバー数</span> <span
						class="actual-member-count" id="validMemberCount">0</span> <span
						class="member-count-unit">人</span>
				</div>
			</div>
			...
			<div class="member-count">
				...
				<div class="member-count-text">
					<span class="member-count-label">管理者数</span> <span
						class="actual-member-count" id="adminMemberCount">0</span> <span
						class="member-count-unit">人</span>
				</div>
			</div>
			...
			<div class="member-count">
				...
				<div class="member-count-text">
					<span class="member-count-label">無効メンバー数</span> <span
						class="actual-member-count" id="invalidMemberCount">0</span> <span
						class="member-count-unit">人</span>
				</div>
			</div>
		</section>
		...
		<section class="member-search">
			<div class="search-grid">
				<div class="search-field keyword-field">
					...
					<div class="keyword-input-wrap">
						<span class="search-icon">⌕</span> <input type="text"
							id="keyword-filter" class="keyword" name="keyword"
							placeholder="氏名で検索">
					</div>
				</div>

				<div class="search-field">
					<label for="role-filter">権限</label> <select id="role-filter">
				...
				<div class="search-field">
					<label for="status-filter">状態</label> <select id="status-filter">
						<option value="">すべて</option>
		...
		<c:set var="displayMemberList" value="${users}" />
		<c:if test="${empty displayMemberList}">
			<c:set var="displayMemberList" value="${list}" />
		</c:if>	
		...
		<section class="member-list">
			<div class="member-table-wrap">
				<table id="member-table" class="member-table table table-bordered">
					...
					<tbody>
						<c:forEach var="e" items="${displayMemberList}">
							<tr>
								<td class="login-id-cell"><c:out value="${e.loginId}" /></td>
								...
								<td>
									<div class="action-cell">
										<form action="${pageContext.request.contextPath}/Controller"
											method="get">
											<input type="hidden" name="page_id" value="M003"> <input
												type="hidden" name="user_id" value="${e.userId}">
										...
										<div class="more-menu-wrap">
											...
											<div class="more-menu">
												<form action="${pageContext.request.contextPath}/Controller"
													method="get">
													<input type="hidden" name="page_id" value="M004"> <input
														type="hidden" name="user_id" value="${e.userId}">
												...
												<form action="${pageContext.request.contextPath}/Controller"
													method="post" data-confirm="このメンバーを有効化しますか">
													<input type="hidden" name="page_id" value="M003"> <input
														type="hidden" name="user_id" value="${e.userId}">
													<input type="hidden" name="is_valid" value="true">
													<button type="submit" name="button_id" value="有効化"
														class="more-menu-item">有効化</button>
												</form>

												<form action="${pageContext.request.contextPath}/Controller"
													method="post" data-confirm="このメンバーを無効化しますか">
													<input type="hidden" name="page_id" value="M003"> <input
														type="hidden" name="user_id" value="${e.userId}">
													<input type="hidden" name="is_valid" value="false">
													<button type="submit" name="button_id" value="無効化"
														class="more-menu-item">無効化</button>
												</form>
											</div>
										</div>
									</div>
